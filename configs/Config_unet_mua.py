...
def get_config():
    ...
    data_root_dir = '/workplace/data/2D'  # The path where the downloaded dataset is stored.
    ...
    c = Config(
        ...
        data_dir=os.path.join(data_root_dir, '20200306_optical_prop_rough'),  # This is where your training and validation data is stored
        data_test_dir=os.path.join(data_root_dir, '20200306_optical_prop_rough'),  # This is where your test data is stored
